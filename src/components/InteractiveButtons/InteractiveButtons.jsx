...
const InteractiveButtons = ({
  ...
  useEffect(() => (page === 'about' ? setAbout(true) : setAbout(false)), [])
    ...
    <>
      <span className={open === false ? 'icons--hide' : null}>
        <span
          onClick={close}
          className={
            about === false ? 'dot dot--red' : 'dot dot__about dot--red'
          }
        >
          <span className="sign sign--red">x</span>
        </span>
        <span
          ...
          className={
            about === false
              ? 'dot dot--yellow'
              : 'dot dot__about dot--yellow dot__about--yellow'
          }
        >
          <span className="sign sign--yellow">-</span>
        </span>
        <span
          onClick={maximizeTerminal}
          className={
            about === false ? 'dot dot--green' : 'dot dot__about dot--green'
          }
        >
          <span className="sign sign--green">
            <svg height="8px" viewBox="0 0 32 32" width="8px">
